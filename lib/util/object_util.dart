...
class ObjectUtil {
  ...
  */
  ...
  static String imgWaterStr(String data){
      ...
      String shareUrl='https://cacart.oss-cn-hangzhou.aliyuncs.com/wxapp/group/share_bg.jpg?x-oss-process=image/resize,m_fill,h_400,w_500/watermark,image_${base64},g_center' ;
      return shareUrl;
  ...
  static String waterBgAndString(String data){
    ...
    print('arr-------------${baseq}');
    String base64 =baseq.replaceAll('+', '-');
    String shareUrl='https://cacart.oss-cn-hangzhou.aliyuncs.com/wxapp/group/share_bg.jpg?x-oss-process=image/resize,m_fill,h_400,w_500/watermark,text_${base64},g_center' ;
